defmodule EvlDaemon.EventNotifier.EmailTest do
  ...
  setup do
    ...
    {:ok, _notifier} = EvlDaemon.EventNotifier.Email.start_link(event_dispatcher, [recipient: "person@example.com"])
  ...
  test "successfully emails the event", %{event_dispatcher: event_dispatcher} do
    ...
    notification = EvlDaemon.Email.Event.build("60111F9", timestamp, "person@example.com")
